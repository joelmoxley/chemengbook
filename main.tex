...
\usepackage{array}% http://ctan.org/pkg/array—To modify tabular rows and columns
\newcolumntype{M}{>{\centering}m{\dimexpr.25\linewidth-2\tabcolsep}}%New type of column which is vertically aligned
\usepackage{geometry}
\textheight=580pt						
\footskip=45pt
\topmargin=-20pt
