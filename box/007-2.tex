\begin{mitframe}{007-2} % 20160707MAC
    ...
    \begin{listone}
      ...
      % 20160707MAC: F = -du/dr, sign should be negative.
      % 20160707MAC: 'u' here should be 'phi' or the intermolecular potential.
      ...
      % 20160707MAC: 'k' is not '\thermcond', it is the Boltzmann constant
      
      % 20160707MAC: all 'epsilon' are not '\dielec' nor 'energy well depth' but just coefficients that depend on the identity of the molecules (e.g. "coefficient of dipole-dipole", "coefficient of dispersion-attraction", "coefficient of repulsion"). Some references descride as just constants.
