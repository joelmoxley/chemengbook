\begin{mitframe}{008-2} % 20160715MAC
...
\begin{listone}
    ...
    %'n' is an undeclared symbol. not indexed
    % 20160707MAC: 'n' is defined as "chain length of polymer" or "number of monomer units" (Tester, p.482)
    ...
    \begin{listtwo}
        ...
        % 20160715MAC: '\fhmolefrac{\crit,2}' should be '\fhmolefrac{2,\crit}', look at equation below 
