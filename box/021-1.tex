...
%row 6     
\textbf{\textit{R EOS}} &%
{ \p&=\dfrac{\gasconst\Temp}{\vol-b}-\dfrac{a}{\vol(\vol+b)+b(\vol-b)} \\ \Rightarrow& a=\dfrac{0.45724{\gasconst}^{2}{\Temp_{c}}^{2}}{\p_{c}}\bigg(1+\comeback\bigg(1-\sqrt{\Temp_{r}}\bigg)\bigg)^{2} \\ &\Rightarrow \comeback=0.37464+1.54226\mpf-0.26992{\mpf}^{2} \\ \Rightarrow& b=\dfrac{0.07780\gasconst\Temp_{c}}{\p_{c}} } &%
\dots &%
 -\dfrac{\gasconst\Temp}{(\vol-b)^{2}}+\dfrac{2a(\vol+b)}{[\vol(\vol+b)+b(\vol-b)]^{2}}  \\ \hline
