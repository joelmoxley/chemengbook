\begin{mitframe}{004-1} % 20160714MAC
	...
	\begin{listone}
    	...
    	% 20160714MAC: 'e' here is the constant "e" which is the base of the natural logarithm (Tester, Eq.10-68) <>unresolved<>
    	% 20161019BFF: 'e' is changed into a new variable "Euler's number" with '\e' command
    	...
    	% 20161019BFF: 'e' is changed into a new variable base of the natural logarithm with '\e' command
    ...
    % 20160714MAC: 'n' here is 'N' or "\nummoles" from the equation PV = NkT <resolved>
    ...
    % 20161019BFF: not sure about "\vvel"
    % 20161019BFF: '\vvel' is changed into '\waven' for "wavenumber" 
