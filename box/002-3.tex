...
\begin{listone}
    ...
    %'n_{i}' is an unknown symbol, changed to '\molspecies' <resolved>
    ...
    % 20160705MAC: '\helmholtz' should be 'uline{\helmholtz}' meaning "total helmholtz free energy" instead of "specific helmholtz free energy" (Tester, p.xv & p.401, Eq.10-48) See also Box 3-1 <resolved>
